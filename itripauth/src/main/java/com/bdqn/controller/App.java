...
public class App 
{
	public static String account = "q2510414552@163.com";			//替换为发件人账号
    public static String password = "WAGFNDDPYSGOIRYZ";					//替换为发件人账号密码
    ...
    public static MimeMessage createMimeMessage(String code,Session session, String sendMail, String receiveMail)
        ...
        // 5. Content: 邮件正文
        message.setContent("我永远年轻，永远怀念曾经", "text/html;charset=UTF-8");
        // 6. 设置发件时间
